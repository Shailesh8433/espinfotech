    ...
    <main role="main">
        ...
        <div class="container">
          ...
          <div class="box">							
            <div class="icon">
              ...
              <div class="info">
                <h3 class="title">Desktop Repairing</h3>
                <p>
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <div class="box">							
            <div class="icon">
              ...
              <div class="info">
                <h3 class="title">Laptop Repairing</h3>
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <div class="box">							
            <div class="icon">
              <div class="image"><i class="fa fa-flag"></i></div>
              <div class="info">
                <h3 class="title">Computer Assembling</h3>
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <div class="box">							
            <div class="icon">
              <div class="image"><i class="fa fa-flag"></i></div>
              <div class="info">
                <h3 class="title">Annual Maintenance</h3>
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <div class="box">							
            <div class="icon">
              <div class="image"><i class="fa fa-flag"></i></div>
              <div class="info">
                <h3 class="title">Sales & Service</h3>
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <div class="box">							
            <div class="icon">
              <div class="image"><i class="fa fa-flag"></i></div>
              <div class="info">
                <h3 class="title">Digital Solution</h3>
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <p class="lead text-muted">Do you have any questions? Please do not hesitate to contact us directly. Our team will come back to you within
  ...
  <div class="row">
      ...
      <div class="col-md-9 mb-md-0 mb-5">
          ...
          <div class="text-center text-md-left">
              <a class="btn btn-primary my-2" onclick="document.getElementById('contact-form').submit();">Send</a>
              <!-- <a href="#" class="btn btn-primary my-2">Main call to action</a> -->
          </div>
