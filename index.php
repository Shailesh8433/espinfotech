  ...
  <div class="container py-5 ">
    <div class="row">
      ...
      <div class="container-fluid">
          ...
          <div class="col-lg-3 col-md-4 m-2 " data-aos="fade-right" id="icons" >
            ...
            <div class="col-lg-3 col-md-4 m-2 "data-aos="fade-left" id="icons">
...
<button class="btn btn-lg btn-primary" type="button"> save</button>
                  ...
                  <div class="col-lg-6 col-md-12 responsive mt-2" data-aos="fade-left">
